  ...
  return (
    ...
    >
      <div className="mx-auto ">
        <h1 className="mb-4 text-5xl font-extrabold tracking-wide text-transparent font-kanit bg-clip-text bg-gradient-to-r to-secondary from-primary lg:text-7xl ">
          <span className="block text-transparent bg-clip-text bg-gradient-to-r to-secondary from-primary">
            Hi! I am
          </span>{' '}
          Abel Kifletsion.
        </h1>
